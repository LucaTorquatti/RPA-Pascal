...
begin
    ...
    if hs_A < hs_B then resultado :=  'A';
    if hs_A > hs_B then resultado := 'B';
    if hs_A = hs_B then
     if min_A < min_b then resultado := 'A' ;
     if min_A > min_B then resultado := 'B';
     if min_A = min_B then
      if seg_A < seg_B then resultado := 'A';
      if seg_A > seg_B then resultado := 'B';
    ...
    else if (resultado <> 'A') and (resultado <> ' B ') then  writeln( ' La carrera ha resultado empate');
